...
import { Button, TextInput, Text, View, StyleSheet, TouchableHighlight, StatusBar, FlatList, RefreshControl,ScrollView, Image, TouchableOpacity, Modal, ImageBackground, Alert } from 'react-native'
                ...
                <View style={{ marginBottom: 10, marginRight: 10, backgroundColor: 'white', elevation: 5, borderRadius: 8, padding: 10, width: '80%' }}>
                    <View>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <TouchableOpacity style={{ flex: 1 }} onPress={() => {SelectComment() ,setModalVisible(true) }}>
                                <Icon
                                    name='refresh-circle'
                                    size={14}
                                    color={'green'}
    ...
    return (
        <View style={{ flex: 1 }} >
            ...
            <View  style={{
                ...
                justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#fff',borderTopWidth:0.5
            }}>
